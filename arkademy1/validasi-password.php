...
// Membuat variabel
	...
	if(isset($_POST['submit'])){
		...
		if(!preg_match("/^[a-zA-Z-123]*$/",$username)){
		...
		if(strlen($pass) >= 8){
			...
			$valid_panjang_pass_msg = "Password maksimal 8 karakter.<br>";
		}
